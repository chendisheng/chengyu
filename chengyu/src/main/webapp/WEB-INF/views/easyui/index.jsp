...
<head id="Head1">
    ...
    <link href="${ctx}/static/easyui/css/default.css" rel="stylesheet" type="text/css" />
    <link rel="stylesheet" type="text/css" href="${ctx}/static/easyui/js/themes/default/easyui.css" />
    <link rel="stylesheet" type="text/css" href="${ctx}/static/easyui/js/themes/icon.css" />
    <script type="text/javascript" src="${ctx}/static/easyui/js/jquery-1.4.2.min.js"></script>
    <script type="text/javascript" src="${ctx}/static/easyui/js/jquery.easyui.min-1.2.0.js"></script>
	<script type="text/javascript" src='${ctx}/static/easyui/js/outlook.js'> </script>
...
<div style=" position:absolute; z-index:100000; height:2046px;top:0px;left:0px; width:100%; background:white; text-align:center;">
    ...
    <div region="north" split="true" border="false" style="overflow: hidden; height: 30px;
        ...
        <span style="padding-left:10px; font-size: 16px; float:left;"><img src="${ctx}/static/easyui/images/blocks.gif" width="20" height="20" align="absmiddle" /> 我的帐本</span>
